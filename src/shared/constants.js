(function initConstants(global) {
  ...
  namespace.Constants = Object.freeze({
    ...
    EXPORT_FILENAME: "chatgpt_extracted_conversation.txt",
    STATUS_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_GET_STATUS",
    ARCHIVE_ACTION_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_ARCHIVE_ACTION",
    EXPORT_CONVERSATION_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_EXPORT_CONVERSATION",
    PREPARE_TEXT_EXPORT_DOWNLOAD_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_PREPARE_TEXT_EXPORT_DOWNLOAD",
    TRACK_TEXT_EXPORT_DOWNLOAD_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_TRACK_TEXT_EXPORT_DOWNLOAD",
    RELEASE_TEXT_EXPORT_DOWNLOAD_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_RELEASE_TEXT_EXPORT_DOWNLOAD",
    OFFSCREEN_CREATE_BLOB_URL_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_OFFSCREEN_CREATE_BLOB_URL",
    OFFSCREEN_REVOKE_BLOB_URL_MESSAGE_TYPE: "RAPID_VIEW_FOR_CHATGPT_OFFSCREEN_REVOKE_BLOB_URL",
    ...
    LIMITS: Object.freeze({
      ...
      archiveIndexDelayMs: 40,
      archiveIndexRetryDelayMs: 180,
